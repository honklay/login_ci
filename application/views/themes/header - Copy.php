      ...
      <div class="container">
        ...
        <div id="navbar" class="collapse navbar-collapse">
          <ul class="nav navbar-nav">
            ...
            <li><a href="<?php echo base_url()?>otentifikasi/why"><i class="glyphicon glyphicon-tasks"></i> Why</a></li>
            <li><a href="<?php echo base_url()?>otentifikasi/services"><i class="glyphicon glyphicon-cog"></i> Services</a></li>
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
              	 <li><a href="<?php echo base_url()?>otentifikasi/about"><i class="glyphicon glyphicon-user"></i> About</a></li>
                <li><a href="<?php echo base_url()?>otentifikasi/contact"><i class="glyphicon glyphicon-envelope"></i> Contact</a></li>
              </ul>
            </li>
          </ul>
        </div><!--/.nav-collapse -->
